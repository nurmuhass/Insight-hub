<?php
	...
	class Model{
		...
		// public static $dbName="civilvil_aduvtudb"; //Database Name
		...
		public $emailUsername="business@aduikirun.com.ng"; //Support Email Address
		public $emailPassword="0816616Dami$$$$"; //Support Email Password
