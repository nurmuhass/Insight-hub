<div class="page-content header-clear-medium">
        ...
        <div class="card card-style">
            ...
            <div class="content">
                ...
                <hr/>
                <div class="d-flex">
                    <h5 style="background:#555; color:#ffffff; padding:9px;  margin-right:5px;border-radius:0.5rem;">Code </h5>
                    <marquee direction="left" scrollamount="5" style="background:#f2f2f2; padding:3px; border-radius:1rem;">
                        <h5 class="py-2">
